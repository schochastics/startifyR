quotes <- list(
    ...
    c("Simplicity does not precede complexity, but follows it.", "", "- Alan Perlis"),
    c("Optimization hinders evolution.", "", "- Alan Perlis"),
    c(
    ...
    c("I would rather die of passion than of boredom.", "", "- Vincent Van Gogh"),
    ...
    c('Patterns mean "I have run out of language."', "", "- Rich Hickey"),
    c(
    ...
    c("Caches are bugs waiting to happen.", "", "- Rob Pike"),
    c(
    ...
    c("Coding ain't done 'til all the Tests run.", "", "'Nuff said."),
    c(
    ...
    c("Invest regularly in your knowledge portfolio.", "", "Make learning a habit."),
    c(
    ...
    c("To iterate is human, to recurse divine.", "", "- L. Peter Deutsch"),
    c("Computers are useless. They can only give you answers.", "", "- Pablo Picasso"),
    c(
    ...
    c("First, solve the problem. Then, write the code.", "", "- John Johnson"),
    c(
    ...
    c("All programming is an exercise in caching.", "", "- Terje Mathisen"),
    c("Software is hard.", "", "- Donald Knuth"),
    c("They did not know it was impossible, so they did it!", "", "- Mark Twain"),
    c(
    ...
    c("640K ought to be enough for anybody.", "", "- Bill Gates, 1981"),
    c(
...
usethis::use_data(ascii_art, overwrite = TRUE)
